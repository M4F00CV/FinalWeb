...
class AlumnosView(generics.CreateAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if id_alumno:
            try:
                ...
                # Agregar datos del usuario (first_name, last_name, email)
                data["first_name"] = alumno.user.first_name
                data["last_name"] = alumno.user.last_name
                data["email"] = alumno.user.email
                
                return Response(data, 200)
            except Alumnos.DoesNotExist:
                return Response({"message": "Alumno no encontrado"}, 404)
    ...
    def put(self, request, *args, **kwargs):
        ...
        # Actualización de datos del perfil Alumno
        ...
        # Actualizamos los datos del usuario asociado (Auth User)
        user = alumno.user
