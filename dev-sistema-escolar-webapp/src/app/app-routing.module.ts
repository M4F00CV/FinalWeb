...
import { EventosRegistroScreenComponent } from './screens/eventos-registro-screen/eventos-registro-screen.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'eventos-registro', component:  EventosRegistroScreenComponent } ,
      { path: 'eventos-registro/:id', component:  EventosRegistroScreenComponent},
      { path: 'eventos/:id', component:  EventosRegistroScreenComponent}
    ]
  },
  // fallback route
