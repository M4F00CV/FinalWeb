...
export class MaestrosService {
  ...
  public eliminarMaestro(isMaestro: number): Observable<any> {
    ...
    return this.http.delete<any>(`${environment.url_api}/maestros/?id=${isMaestro}`, { headers });
  }
